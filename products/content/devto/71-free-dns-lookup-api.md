---
title: "Free DNS Lookup API: Query Any Domain Records via REST"
published: false
tags: dns,api,devops,networking
canonical_url: https://toolpipe.dev
---

# Free DNS Lookup API: Query Any Domain Records via REST

Need to query dns records for any domain in your app? Skip the library installation. ToolPipe's free REST API handles it with a single HTTP call.
